...
namespace AmplifyShaderEditor
{
	public class TemplateMenuItems
	{
		...
		[MenuItem( "Assets/Create/Amplify Shader/Templates/Double", false, 85 )]
		public static void ApplyTemplateTemplatesDouble()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "740366da6c342ad4fb3790eaa1cdad32" );
		}
